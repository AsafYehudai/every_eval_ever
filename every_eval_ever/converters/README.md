...
```bash
every_eval_ever convert inspect eee --log-path tests/data/inspect/2026-02-07T11-26-57+00-00_gaia_4V8zHbbRKpU5Yv2BMoBcjE.json
```
...
```bash
every_eval_ever convert helm eee --log-path tests/data/helm/commonsense:dataset=hellaswag,method=multiple_choice_joint,model=eleutherai_pythia-1b-v0
```
...
```bash
every_eval_ever convert lm_eval eee --log-path tests/data/lm_eval/results_2026-01-21T03-44-18.458309.json
```
